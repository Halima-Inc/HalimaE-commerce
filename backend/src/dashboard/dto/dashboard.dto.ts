...
export class PeakPeriodDto {
    ...
    @ApiProperty({ description: 'Revenue during this period', example: 5000.0 })
...
export class OrdersByLocationDto {
    ...
    @ApiProperty({
        description: 'Total number of orders from this location',
        example: 150,
    })
    readonly count: number;

    @ApiProperty({
        description: 'Total revenue from this location',
        example: 25000.0,
    })
    readonly revenue: number;
}
...
export class BestSellingProductDto {
    ...
    @ApiProperty({ description: 'Total revenue generated', example: 12500.0 })
    readonly revenue: number;
}
...
export class DashboardDto {
    ...
    @ApiProperty({ description: 'Total discounts applied', example: 25000.0 })
    ...
    @ApiProperty({
        ...
        example: { EGP: 120000.0, USD: 30000.0 },
    })
    readonly revenueByCurrency: Record<string, number>;

    @ApiProperty({
        description: 'Sales breakdown by time periods',
        type: SalesByPeriodDto,
    })
    ...
    @ApiProperty({
        ...
        example: { PENDING: 50, CONFIRMED: 200, DELIVERED: 1000 },
    })
    ...
    @ApiProperty({ description: 'Average Order Value (AOV)', example: 120.0 })
    readonly aov: number;
    ...
    @ApiProperty({
        description: 'New customer registrations by day',
        example: { '2025-12-01': 15, '2025-12-02': 20 },
    })
