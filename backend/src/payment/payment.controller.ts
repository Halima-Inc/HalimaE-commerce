...
import { JwtAccessTokenGuard } from '../auth/presentation';
import {
...
export class PaymentController {
    ...
    @ApiOperation({
        ...
        description:
            'Receives payment status updates from Paymob payment provider. Updates order payment status based on transaction outcome.',
    })
    @ApiHeader({
    ...
    @ApiOperation({
        ...
        description:
            'Records a cash payment for an order. Used by admin or courier when cash is received upon delivery.',
    })
    @ApiParam({
        name: 'orderId',
